...
class ProjectBlueprintController extends GetxController {
  ...
  _createSelectedPlane() {
    ...
    final firstTopPoint = vector.Vector3(listSelectedPoints.last!.x,
        listSelectedPoints.last!.y + 0.2, listSelectedPoints.last!.z);
    final secondTopPoint = vector.Vector3(listSelectedPoints.first!.x,
    ...
    final selectedPlane = ARKitPlane(
      ...
      materials: [
        // ARKitMaterial(
        //   transparency: 1.0,
        //   diffuse: ARKitMaterialProperty.image("assets/design.jpeg"),
        // )
        ARKitMaterial(
          transparency: 0.7,
    ...
    selectedPlaneNode.value = ARKitNode(
        ...
        eulerAngles: vector.Vector3(
            (planeDirection.value! > 0) ? planeAngle : -planeAngle, 0, 0));
